...
# Save these with absolute paths
...
# Save model explicitly to the same directory
model.save(os.path.join(BASE_DIR, 'chatbot_model.h5'))
print("Model trained and saved successfully at:", os.path.join(BASE_DIR, 'chatbot_model.h5'))
